    ...
    <main className="landing">
      <div className="container">
        ...
        <header className="brand" style={{ marginBottom: 20 }}>
          ...
          <div>
            <h1 className="title">Browse rentals</h1>
            <p className="subtitle">Hand-picked gear and tools available today.</p>
          </div>
        </header>

        <section className="grid-products" id="deals">
          {products.map((p) => (
            <article key={p.id} className={`product-card cat-${p.category?.toLowerCase().replace(/\s+/g,'-')}`}> 
              ...
              <div className="meta">
                ...
                <div className="p-bottom">
                  ...
                  <a className="p-cta" href="#">Rent now</a>
                </div>
              </div>
            </article>
          ))}
